...
describe('Pages', () => {
    it('Como usuario deseo crear una nueva pagina', () => {
        ...
        steps.setDirrectoryReport("pages_create__folder");
        //LoginStart
        steps.login();
        steps.waiting(1500);
        steps.TakePicture();
    ...
    it('Como usuario deseo agendar la creación de una nueva pagina', () => {
        steps.setIdScreenImage("a");
        steps.setDirrectoryReport("pages_schedule__folder");
        //LoginStart
        steps.login();
        steps.waiting(1500);
        //LoginEnd
    ...
    it('Como usuario deseo hacer unschedule de una pagina agendada', () => {
        steps.setIdScreenImage("a");
        steps.setDirrectoryReport("pages_unschedule__folder");
        //LoginStart
        steps.login();
        steps.waiting(1500);
        //LoginEnd
    ...
    it('Como usuario deseo hacer unpublish de una pagina publicada', () => {
        steps.setIdScreenImage("a");
        steps.setDirrectoryReport("pages_unpublish__folder");
        //LoginStart
        steps.login();
        steps.waiting(1500);
        //LoginEnd
    ...
    it('Como usuario deseo eliminar una pagina', () => {
        steps.setIdScreenImage("a");
        steps.setDirrectoryReport("Pages");
        //LoginStart
        steps.login();
        steps.waiting(1500);
        //LoginEnd

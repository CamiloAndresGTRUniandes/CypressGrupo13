    ...
    constructor() {
        ...
        this.getElementPath = (item) => {
            switch (true) {
                ...
                case item.includes('publish post old version'):
                    return jsonData['posts']['publishButtonOld'];
                case item.includes('publish post'):
                    return jsonData['posts']['publishButton'];
                case item.includes('back to editor old version'):
                    return jsonData['posts']['backToEditorOld'];
                ...
                case item.includes('schedule it old version'):
                    return jsonData['posts']['scheduleItOld'];
